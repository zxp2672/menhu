-- 创建数据库
CREATE DATABASE IF NOT EXISTS zhida_portal 
...
VALUES (
  'admin',
  '$2a$10$XoKNR5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5B5',
  'admin@zhida-tech.com',
  'admin',
  'active',
  NOW(),
  NOW()
...
-- 插入初始解决方案数据
INSERT INTO solutions (type, title, description, createdAt, updatedAt) VALUES
